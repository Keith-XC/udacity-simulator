...
{
    private string[] trackNames = new string[] { "LakeTrack", "JungleTrack", "MountainTrack", "CityTrack", "GeneratedTrack"};
    ...
    public void Start()
    {
        ...
        for (int i = 0; i < tracks.Length; i++)
        {
            ...
            else if (trackOption.name == "City Track")
            {
                outlines[3] = trackOption;
            }
            else if (trackOption.name == "Generated Track")
            {
                outlines[4] = trackOption;
            }
        }
    ...
    public void StartDrivingMode()
    {
        ...
        if (trackIndex >= 3)
        {
            SceneManager.LoadScene(trackNames[trackIndex]);
        }
        else
        {
    ...
    public void SetCityTrack()
    {
        trackIndex = 3;
        setNormalAugmentation();
        outlines[0].effectColor = new Color(255, 255, 255);
        outlines[2].effectColor = new Color(255, 255, 255);
        outlines[trackIndex].effectColor = new Color(0, 0, 0);
    }
