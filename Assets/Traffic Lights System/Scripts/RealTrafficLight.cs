...
namespace Assets.Traffic_Lights_System.Scripts
{
    public class RealTrafficLight : TrafficLightBase
    {
        ...
        public void SetLightState(LightState lightState)
        {
            ...
            {
                OnLightStateChanged(true, false, false);
            }

            if (lightState == LightState.Yellow)
            {
                OnLightStateChanged(false, true, false);
            }

            if (lightState == LightState.Green)
            {
                OnLightStateChanged(false, false, true);
            }

            if (lightState == LightState.RedYellow)
            {
                OnLightStateChanged(true, true, false);
            }
        }
    }
}
